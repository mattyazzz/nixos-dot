...

{
    ...
    xdg.configFile."nvim".source =./mydots/nvim;
    xdg.configFile."kitty".source =./mydots/kitty;
    xdg.configFile."qtile".source =./mydots/qtile;
    xdg.configFile."waybar".source =./mydots/waybar;
